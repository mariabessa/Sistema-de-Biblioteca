...
public class CadastroFunc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 440, 250, 30));
        ...
        CadastroFunc.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        CadastroFunc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CadastroFuncActionPerformed(evt);
            }
        });
        getContentPane().add(CadastroFunc, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 680, 300, 50));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cadastroFuncionario.png"))); // NOI18N
