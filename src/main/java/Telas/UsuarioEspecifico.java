 ...
 * @author maria
 */
public class UsuarioEspecifico extends javax.swing.JFrame {
    private Usuario usuario;


    public UsuarioEspecifico(Usuario usuario) {
        initComponents();
        this.usuario = usuario;
        mostrarUsuario();
    }
    private void mostrarUsuario() {
        jTextFieldId.setText(usuario.getId().toString()); // Define o ID como texto no campo de texto
        jTextFieldId.setEditable(false);
        jTextFieldNome.setText(usuario.getNome()); // Define o nome no campo de texto
        jTextFieldNome.setEditable(false);
        jTextFieldReg.setText(usuario.getRegistroAcademico().toString()); // Define o ID como texto no campo de texto
        jTextFieldId.setEditable(false);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldReg, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 410, 290, 30));
    ...
    private void AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AtualizarActionPerformed
        ContextoLivro.setIdAtual(usuario.getId());
        AtualizacaoUsuario atualizacaoUsuario = new AtualizacaoUsuario();
        atualizacaoUsuario.setVisible(true);
        dispose();
    ...
    private void VoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VoltarActionPerformed
        // TODO add your handling code here:
        TelaUsuarios login = new TelaUsuarios();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioEspecifico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
        UsuarioEspecifico livroEspecifico = new UsuarioEspecifico(new Usuario("o", "o", "o",123)); // Fornecer um objeto Livro como argumento
