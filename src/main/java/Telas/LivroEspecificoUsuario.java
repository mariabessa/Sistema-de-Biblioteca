 ...
 * @author maria
 */
public class LivroEspecificoUsuario extends javax.swing.JFrame {
    private Livro livro;
    ...
    public LivroEspecificoUsuario(Livro livro) {
        initComponents();
        this.livro = livro;
        mostrarLivro();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livroUsu.png"))); // NOI18N
    ...
    private void VoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VoltarActionPerformed
        // TODO add your handling code here:
        ConsultaLivros tela = new ConsultaLivros();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LivroEspecificoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
        LivroEspecificoUsuario livroEspecifico = new LivroEspecificoUsuario(new Livro("o", "o", 123, new ArrayList<>(), new ArrayList<>())); // Fornecer um objeto Livro como argumento
